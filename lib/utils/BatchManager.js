  ...
  _createClass(BatchManager, [{
    ...
    value: function () {
      function render(token) {
        ...
        return Promise.resolve(result).then(function (functionIn) {
          // ensure that we have this component registered
          var renderFn = functionIn && functionIn[name] ? functionIn[name] : functionIn && functionIn['default'] ? functionIn['default'] : {};
